package com.lbu.lbufinance.commons.auth.service.impl;
...
import static com.lbu.lbufinance.commons.constants.ErrorConstants.*;
...
public class AuthServiceImpl implements AuthService {
     ...
     * @throws LbuFinanceRuntimeException If an error occurs during authentication.
     */
    @Override
     ...
     * @throws LbuFinanceRuntimeException If the token is invalid or if the user href doesn't match with the token.
     */
    @Override
     ...
     * @param authToken The JWT token.
     * @return The validated authentication user href.
     * @throws LbuFinanceRuntimeException If the token is invalid or if the user href cannot be retrieved.
     */
    @Override
     ...
     * @throws LbuFinanceRuntimeException If the token is invalid or if an error occurs during validation.
     */
