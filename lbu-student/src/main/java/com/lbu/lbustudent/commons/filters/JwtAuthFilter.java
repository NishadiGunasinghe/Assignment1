package com.lbu.lbustudent.commons.filters;
...
import static com.lbu.lbustudent.commons.constants.ErrorConstants.JWT_TOKEN_NOT_AVAILABLE;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        } catch (LBUStudentsRuntimeException ex) {
    ...
    private void processAuthHeader(String authHeader) {
        ...
        if (matcher.find()) {
            ...
            throw new LBUStudentsRuntimeException(JWT_TOKEN_NOT_AVAILABLE.getErrorMessage(), JWT_TOKEN_NOT_AVAILABLE.getErrorCode());
        }
    ...
    private void generateErrorMessage(HttpServletResponse response, LBUStudentsRuntimeException ex) throws IOException {
