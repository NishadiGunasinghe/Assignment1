...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        } catch (LBUCourcesRuntimeException ex) {
    ...
    private void processAuthHeader(String authHeader) {
        ...
        if (matcher.find()) {
            ...
            throw new LBUCourcesRuntimeException(JWT_TOKEN_NOT_AVAILABLE.getErrorMessage(), JWT_TOKEN_NOT_AVAILABLE.getErrorCode());
        }
    ...
    private void generateErrorMessage(HttpServletResponse response, LBUCourcesRuntimeException ex) throws IOException {
