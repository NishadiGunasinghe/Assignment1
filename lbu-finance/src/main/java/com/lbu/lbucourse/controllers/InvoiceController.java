...
public interface InvoiceController {
    ...
    @ApiResponse(
            ...
            content = @Content(mediaType = APPLICATION_JSON_VALUE, schema = @Schema(implementation = FinanceInvoiceDtos.class))
    )
    @ApiResponse(
            responseCode = "400",
    ...
    ResponseEntity<FinanceInvoiceDtos> getFinanceDetailsForUser(@RequestHeader(HttpHeaders.AUTHORIZATION) String token);
