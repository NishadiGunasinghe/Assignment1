...
import com.example.lbuauth.commons.filters.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // JwtAuthFilter for JWT authentication
    private final JwtAuthFilter jwtAuthFilter;
    // UserDetailsService for fetching user details
    ...
    // Creates a RequestMatcher for a specific HTTP method and pattern
